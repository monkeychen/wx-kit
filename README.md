...
![Status](https://img.shields.io/badge/v0.8.1-released-success.svg)
...
去 [Releases](../../releases) 选平台对应包(最新 v0.8.1:`wx-kit-0.8.1-arm64.dmg`(Apple Silicon) /
`wx-kit-0.8.1.dmg`(Intel) / `wx-kit Setup 0.8.1.exe`(Windows))。当前**未签名/未公证**,首次打开需手动放行:
