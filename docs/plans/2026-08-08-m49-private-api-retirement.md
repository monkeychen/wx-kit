# v0.9.0 M49 私有文章列表能力退场实现计划

> 当前对应需求：`docs/PRD-v0.9.0.md` R2。M49 实施时曾暂归 v0.8.6，版本基线纠正后由 v0.9.0 吸收。
>
> 实施日期：2026-08-08。
>
> 状态：已完成。验证结果见 `docs/PRD-v0.9.0.md` M49 已完成证据与 devlog §43。
...
### Task 1：版本文档先对齐（历史执行记录）

- 实施时先在 `docs/PRD-v0.8.6.md` 记录 M49 边界和验收；随后确认 v0.8.6/v0.8.7 均不发布，当前契约迁入 `docs/PRD-v0.9.0.md`。
- `ROADMAP.md` 以 v0.9.0 为下一公开版本，v0.8.6/v0.8.7 只保留历史去向。
- 不发布 M44–M49 的任何 v0.8.6 形态。
