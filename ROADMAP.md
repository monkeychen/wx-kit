...
- **当前开发:v0.10.3(M57)已实现待发版(2026-09-08)** —— 三个小修落地:CLI wrapper 临时位置守卫(打包实机验证)+ 文库筛选下拉显示公众号名称(含跳转空态传名)+ 订阅页「识别」全程反馈。574 单测 + e2e 全绿,PRD §6 十二条全勾。需求/验收 `docs/PRD-v0.10.3.md`;阅读数需求经 spike 证伪不入版(见候选池)。
