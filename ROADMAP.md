...
- **当前开发:v0.10.3(M57,2026-09-07 立项,09-08 增补 R3)** —— 三个小修:CLI wrapper 临时位置守卫 + 文库筛选下拉显示公众号名称(修 M56 跳转显示裸 ID)+ 订阅页「识别」全程反馈(loading/空输入/零候选不再盲等)。需求/验收 `docs/PRD-v0.10.3.md`;阅读数需求经 spike 证伪不入版(见候选池)。
