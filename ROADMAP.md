...
- **当前开发:v0.10.0 (微信读书后端)** —— M52/M53 已完成（代码/测试/文档齐备，待发版）。订阅闭环复活；**按公众号批量下载因列表接口被服务端按账号封禁（2026-08-27 spike 终局，见 AGENTS.md）于 2026-08-28 再度停用**，入口已移除。验收契约 `docs/PRD-v0.10.0.md` §6。
